...
export function destructurePerson3() {
    ...
    console.log(`Name: ${personName}, age: ${age}, job: ${job}`)
}
...
export function destructurePerson4() {
    ...
    console.log(name)
    console.log(age)
    console.log(rest) // { job: "teacher", gender: "female", salary: 50000, hobby: "reading", favFood: "pizza" }
}
...
export function destructureArray2() {
    ...
    // Write your code here
    const [getMethod, postMethod, putMethod, delMethod] = methods
